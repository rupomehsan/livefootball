                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        ...
                        <ul class="list-inline text-center">
                            <li><button type="button" class="btn prev-step"><i
                                        class="fa fa-arrow-left"></i>Previous</button></li>
                            <li><button type="button" id="ccConfigNxtBtn" class="btn btn-info-full next-step">Save and
                                    Next  <i class="fa fa-arrow-right"></i></button></li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step6">
                        ...
                        <ul class="list-inline text-center">
                            <li><button type="button" id="configFinishedBtn" class="btn next-step next-step-action">Finised</button></li>
                        </ul>
                    </div>
