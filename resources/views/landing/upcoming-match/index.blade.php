...
@push('custom-js')
    ...
    <script>
        ...
        var getSchedule = "/api/v1/tournament/get-schedule-by-id/" + pageId
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status === 'success') {
                        ...
                        $("#team_squad").append(`
                                   <div class="container">
                                        <div>
                                            ...
                                            <span>${res.data.on_date},${tConvert(res.data.time)}(Match ${res.data.match_no})</span>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center my-3">
                                            ...
                                            <span class="mx-3">${res.data.group.group_name},
                                                        ${res.data.tournament.name}        </span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--ri" width="40" height="40" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="ri:coin-fill" data-width="40" style="color: red;"><path fill="currentColor" d="M23 12v2c0 3.314-4.925 6-11 6c-5.967 0-10.824-2.591-10.995-5.823L1 14v-2c0 3.314 4.925 6 11 6s11-2.686 11-6zM12 4c6.075 0 11 2.686 11 6s-4.925 6-11 6s-11-2.686-11-6s4.925-6 11-6z"></path></svg>
                                                    <span class="mx-3">Match yet to began</span>
                                                </div>
                        ...
                        res.data.first_team.players.forEach(function (player) {
                            $("#firstAllPlayers").append(` <div class="m-3"><h6>${player.name}</h6><span class="text-secondary">${player.role}</span> </div>`)
                        })
                        res.data.second_team.players.forEach(function (player) {
                            $("#secondAllPlayers").append(` <div class="m-3"><h6>${player.name}</h6><span class="text-secondary">${player.role}</span> </div>`)
                        })
