...
@section('content')
    ...
    <div id="point_tbl_select_series">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark"
                                        aria-labelledby="navbarDarkDropdownMenuLink" id="pointTableTournament">
        ...
        <div class="text-center">
            ...
            <div class="container">
                <div class="summery" id="TournamentSummery">
        ...
        <div id="fixtures" class="my-5">
            <div class="container left">
                <div class="row">
                    <div class="col-md-10">
                        <div class="my-3">
                            <h4 class="text-danger" id="tournamentName"></h4>
                        </div>
                        <div class="row" id="pointTable">
                    ...
                    <div class="col-md-2">
                        <div class="adds_img">
                            <a href="" id="siteBannerAddsLink">
                                <img id="siteBannerAddsImage" src="admin/uploads/968a0e49ca2.jpg" class=""
                                     alt="Banner Adds">
                            </a>
                        </div>
...
@push('custom-js')
    <script>
        $(function () {
            $trnmId = "{{request()->segment(2)}}";
            var getAll = "/api/v1/get-point-table-tournament-id/" + $trnmId
            // alert(getAll)
            getAllTeamPointByTournamentId(getAll, "pointTableTournament", null)
