...
--
-- Database: `ccninfot_live_football`
--
...
INSERT INTO `favorite_lists` (`id`, `match_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 14, 1, '2022-09-03 06:06:29', '2022-09-03 06:06:29');
...
(22, 'superadmin@livefootball.com', 'changed', '2022-09-02 03:54:39', '2022-09-02 03:55:02');
...
CREATE TABLE `groups` (
  ...
  `team_id` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ;
...
CREATE TABLE `manage_notifications` (
  `id` bigint UNSIGNED NOT NULL,
  `notification_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'mobile',
  `api_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `match_information` (
  ...
  `first_team_id` bigint DEFAULT NULL,
  `second_team_id` bigint DEFAULT NULL,
  `first_team_squad` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `second_team_squad` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `link_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_team_captain` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_team_captain` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_team_keeper` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_team_keeper` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_team_couch` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_team_couch` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `match_won_infos` (
  ...
  `first_team_id` bigint DEFAULT NULL,
  `second_team_id` bigint DEFAULT NULL,
  `won_team_id` bigint DEFAULT NULL,
  `won_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(89, 'App\\Models\\User', 1, 'authToken', '9c0396902e8b1d9a9d8cf971c4496d6e47b986f3bf6f6f0b4fced5283a3c9d7b', '[\"*\"]', NULL, '2022-09-01 08:38:23', '2022-09-01 08:38:23'),
(90, 'App\\Models\\User', 1, 'authToken', 'd2cb0e6a844657c1e5206b3535bb42aeca77c0d5c58d9b68d13b116a73a62ae5', '[\"*\"]', NULL, '2022-09-01 08:43:34', '2022-09-01 08:43:34'),
(91, 'App\\Models\\User', 1, 'authToken', '735452a7c06f508bdb39733f44fe555f74b6189afaae820077e7d49ad43e1402', '[\"*\"]', NULL, '2022-09-01 23:10:47', '2022-09-01 23:10:47'),
(92, 'App\\Models\\User', 1, 'authToken', 'c4387d44ef20a46cadd3be65e72075f36cff8fed16702375b442ae3068f50586', '[\"*\"]', NULL, '2022-09-01 23:11:31', '2022-09-01 23:11:31'),
(93, 'App\\Models\\User', 1, 'authToken', '9e4b63ed783305dbe88837517bf04c87f5663521b758f158366e9faf109f588f', '[\"*\"]', NULL, '2022-09-02 00:20:28', '2022-09-02 00:20:28'),
(94, 'App\\Models\\User', 1, 'authToken', 'e61d982026e1b1732a598f1f04d824c8abb94cf90702c0fe825b03996207c1db', '[\"*\"]', NULL, '2022-09-03 01:42:06', '2022-09-03 01:42:06'),
(95, 'App\\Models\\User', 1, 'authToken', 'a84a50859a78543847e8f6f233f9e2744e3ef7242078a98ad190fb592b4ed434', '[\"*\"]', NULL, '2022-09-03 01:42:37', '2022-09-03 01:42:37'),
(96, 'App\\Models\\User', 1, 'authToken', 'b71e17c8fe7bcfae5535c33ea20cf6fdfe7c7953ef09f8c9f39d8cdf91e9128b', '[\"*\"]', NULL, '2022-09-03 02:57:03', '2022-09-03 02:57:03'),
(97, 'App\\Models\\User', 1, 'authToken', 'd35692564e81a86148be515fad5d85f7686ef848d1681623a57423ea125088f9', '[\"*\"]', NULL, '2022-09-03 04:23:01', '2022-09-03 04:23:01'),
(98, 'App\\Models\\User', 1, 'authToken', 'cc571f4410b9192c481e7b2c0e4401a90286891caab3481dde849442c63c653c', '[\"*\"]', NULL, '2022-09-03 04:30:05', '2022-09-03 04:30:05'),
(99, 'App\\Models\\User', 1, 'authToken', '10a9a7d909e619470d19edd65d5792e4e22d20c60159dbddc71a167f9007aa01', '[\"*\"]', NULL, '2022-09-03 05:27:19', '2022-09-03 05:27:19'),
(100, 'App\\Models\\User', 1, 'authToken', 'ec7bdb372faf5f773f84f7630f372af0e9a23c291e5ada2758e39e199c9607c2', '[\"*\"]', NULL, '2022-09-03 05:27:48', '2022-09-03 05:27:48'),
(101, 'App\\Models\\User', 1, 'authToken', '9a2a3b5760f4289ad269f23706c9ec25f7f1f6cc995e0b0630e803f535e69aaa', '[\"*\"]', NULL, '2022-09-03 06:06:06', '2022-09-03 06:06:06'),
(102, 'App\\Models\\User', 1, 'authToken', 'ac085f8ab31a1d9473805035e952e99fde0fec22c0c5520e6ceb0ed1fb9d7ff5', '[\"*\"]', NULL, '2022-09-03 07:14:39', '2022-09-03 07:14:39');
...
CREATE TABLE `schedules` (
  ...
  `first_team_id` bigint DEFAULT NULL,
  `second_team_id` bigint DEFAULT NULL,
  `stadium` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `time` time DEFAULT NULL,
  `image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `match_result_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(6, 1, 5, 1, 32, 33, 'Stadium name', '2022-11-21', '22:26:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662209595.ezgif-4-8ab9be214f.jpg', '1', '0', '2022-11-21 16:56:00', '2022-09-03 07:23:17'),
(7, 1, 6, 2, 2, 3, 'Stadium name', '2022-11-22', '22:30:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662210396.ar.jpg', '1', '0', '2022-11-22 17:00:00', '2022-09-03 07:36:39'),
(8, 1, 7, 3, 1, 20, 'Stadium name', '2022-11-23', '22:30:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662211134.ezgif-3-0c7534ecae.jpg', '1', '0', '2022-11-23 17:00:00', '2022-09-03 07:48:57'),
(9, 1, 5, 4, 32, 34, 'Stadium name', '2022-11-24', '13:30:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662210004.q.jpg', '0', '0', '2022-11-24 08:00:00', '2022-09-03 07:30:06'),
(10, 1, 5, 5, 33, 34, 'Stadium name', '2022-11-26', '22:33:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662210203.102250969.jpeg', '0', '0', '2022-11-26 17:03:00', '2022-09-03 07:33:27'),
(11, 1, 6, 6, 3, 35, 'Stadium name', '2022-11-27', '13:48:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662210546.au.jpg', '0', '0', '2022-11-27 08:18:00', '2022-09-03 07:39:08'),
(12, 1, 6, 7, 2, 35, 'Stadium name', '2022-11-27', '22:50:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662210795.002.jpg', '0', '0', '2022-11-27 17:20:00', '2022-09-03 07:43:16'),
(13, 1, 7, 8, 1, 36, 'Stadium name', '2022-11-26', '22:52:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662211330.16x9.jpg', '0', '0', '2022-11-26 17:22:00', '2022-09-03 07:52:12'),
(14, 2, 8, 1, 2, 34, 'Stadium name', '2020-06-26', '19:01:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662211583.soccer-matchday-template-argentina-vs-australia-match-day-template_196584-420.jpg', '1', '1', '2020-06-26 13:31:00', '2022-09-03 07:56:25'),
(15, 2, 8, 2, 2, 35, 'Stadium name', '2020-06-26', '20:01:00', 'https://livefootball.teamprojectx.xyz/uploads/setting/1658843249.maxresdefault (1).jpg', '1', '1', '2020-06-27 00:01:00', '2022-07-26 17:47:31'),
(16, 2, 8, 3, 24, 36, 'Stadium name', '2020-06-24', '21:02:00', 'https://livefootball.teamprojectx.xyz/uploads/setting/1658844209.102024294.jpeg', '1', '1', '2020-06-25 01:02:00', '2022-07-26 18:03:32'),
(17, 2, 9, 4, 1, 32, 'Stadium name', '2020-06-23', '21:02:00', 'https://livefootball.teamprojectx.xyz/uploads/setting/1659945628.maxresdefault (1).jpg', '1', '1', '2020-06-24 01:02:00', '2022-08-08 12:00:34'),
(18, 2, 9, 5, 3, 32, 'Stadium name', '2020-06-22', '20:03:00', 'https://livefootball.teamprojectx.xyz/uploads/setting/1658844414.col-per-en-1643403606671.jpg', '1', '1', '2020-06-23 00:03:00', '2022-07-26 18:06:55'),
(19, 2, 9, 6, 36, 32, 'Stadium name', '2020-06-17', '22:03:00', 'http://livefootball.teamprojectx.xyz/uploads/setting/1658844449.Conmebol_WC_Quali_Peru_Brazil.jpg', '1', '1', '2020-06-18 02:03:00', '2022-07-26 18:07:35'),
(20, 3, 10, 1, 1, 35, 'Stadium name', '2022-07-26', '22:38:00', 'http://livefootball.ccninfotech.com/uploads/setting/1662211706.16x9 (1).jpg', '1', '0', '2022-07-26 17:08:00', '2022-09-03 07:58:28'),
...
CREATE TABLE `settings` (
  ...
  `terms_policy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `teams` (
  ...
  `couch_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'FIFA World Cup 2022', 'http://livefootball.ccninfotech.com/uploads/setting/1662207538.fifa-2022-world-cup-logo-qatar_z5t4wjudq9ty1mh5kqpn38ott.jpg', '2022-07-26 14:11:43', '2022-09-03 06:49:00'),
(2, 'Copa Ameirca 2020', 'http://livefootball.ccninfotech.com/uploads/setting/1662207675.2e292d88aa0f523325b82c8210cbb9ea (1).jpg', '2022-07-26 15:57:28', '2022-09-03 06:51:17'),
(3, 'Summer Olimpic', 'http://livefootball.ccninfotech.com/uploads/setting/1662207767.6aeb5952f4c4afd21f6065a733fcfe15.jpg', '2022-07-26 16:35:32', '2022-09-03 06:52:48');
...
(1, 1, 'Super Admin', 'superadmin@livefootball.com', '00000021421', NULL, 'https://livecricket.teamprojectx.xyz/uploads/admin/1658501117.51f6fb256629fc755b8870c801092942.png', NULL, '$2y$10$u4cdp8v80GdKCKpazYTNsugpFTwfs/LLLTCaYSmR5MSH3KiUoWK6.', 'active', NULL, '2022-07-19 01:55:40', '2022-09-02 03:55:02'),
...
(1, 'header', 'off', NULL, NULL, NULL, NULL, 'off', '0', 'off', '0', 'off', '0', 'off', '0', '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(2, 'site_banner', 'off', NULL, NULL, NULL, NULL, 'off', '0', 'off', '0', 'off', '0', 'off', '0', '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(3, 'upcoming_matches', 'off', NULL, NULL, NULL, NULL, 'off', NULL, 'off', NULL, 'off', NULL, 'off', NULL, '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(4, 'native_series', 'off', NULL, NULL, NULL, NULL, 'off', NULL, 'off', NULL, 'off', NULL, 'off', NULL, '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(5, 'popup', 'off', NULL, NULL, NULL, NULL, 'off', NULL, 'off', NULL, 'off', NULL, 'off', NULL, '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(6, 'custom_header', 'on', NULL, NULL, NULL, '1662104503.Rectangle 1751 (1).png', 'off', NULL, 'off', NULL, 'off', NULL, 'off', NULL, '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(7, 'custom_site_banner', 'on', NULL, NULL, NULL, '1662104503.Rectangle 1751 (1).png', 'off', NULL, 'off', NULL, 'off', NULL, 'off', NULL, '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(8, 'custom_upcoming_matches', 'on', NULL, NULL, 2, '1662104503.Rectangle 1751 (1).png', 'off', NULL, 'off', NULL, 'off', NULL, 'off', NULL, '2022-09-02 02:11:43', '2022-09-02 02:11:43'),
(9, 'custom_popup', 'on', NULL, NULL, 5, '1662104503.Rectangle 1751 (1).png', 'off', NULL, 'off', NULL, 'off', NULL, 'off', NULL, '2022-09-02 02:11:43', '2022-09-02 02:11:43');
...
CREATE TABLE `web_advertisements` (
  `id` bigint UNSIGNED NOT NULL,
  `web_adds` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ;
